...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="tundra spring">
		<div id="wrapper">
		    ...
		    <% if (!((HttpServletRequest)pageContext.getRequest()).getServletPath().equals("/index.jsp")){ %>
		    <div id="nav">
				<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/index.jsp"><span><img src="${pageContext.request.contextPath}/images/icons/back.gif" /><fmt:message key="navigation.backToHome"/></span></a></div>
		    </div>
			<% } %>     
