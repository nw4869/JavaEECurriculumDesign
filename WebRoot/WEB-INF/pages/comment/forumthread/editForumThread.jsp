...
<html>
<head>
<title>Edit <fmt:message key="comment.title"/> <fmt:message key="forumthread.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveCommentForumThread" method="POST" modelAttribute="forumthread">
