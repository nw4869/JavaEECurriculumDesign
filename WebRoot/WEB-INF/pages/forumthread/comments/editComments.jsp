...
<html>
<head>
<title>Edit <fmt:message key="forumthread.title"/> <fmt:message key="comment.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveForumThreadComments" method="POST" modelAttribute="comment">
