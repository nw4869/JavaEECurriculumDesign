...
<html>
<head>
<title>Edit <fmt:message key="forumthread.title"/> <fmt:message key="user.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveForumThreadUser" method="POST" modelAttribute="user">
