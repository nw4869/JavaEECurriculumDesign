...
<html>
<head>
<title>Edit <fmt:message key="forum.title"/> <fmt:message key="forumthread.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveForumForumThreads" method="POST" modelAttribute="forumthread">
