...
<html>
<head>
<title>Edit <fmt:message key="user.title"/> <fmt:message key="comment.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveUserComments" method="POST" modelAttribute="comment">
