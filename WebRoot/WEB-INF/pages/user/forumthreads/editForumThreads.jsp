...
<html>
<head>
<title>Edit <fmt:message key="user.title"/> <fmt:message key="forumthread.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveUserForumThreads" method="POST" modelAttribute="forumthread">
